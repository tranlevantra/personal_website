...
::: {.callout-note collapse="false" title="Terminology"}

### Fulfillment Center

Fulfillment centers are specialized warehouses that store **finished products** and handle picking, packing, and shipping—either to retail stores or directly to customers. 
...
<iframe src="fig/fulfillmentCenterLandscape.html" width="100%" height="600px" style="border:none;"></iframe>
...
- **Altona, Laverton North, and Truganina** remain key warehousing hubs, supported by ample land reserves for ongoing industrial development.
